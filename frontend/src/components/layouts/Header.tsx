...
export const Header = () => {
  ...
  const { setChat, showChatList, setShowChatList } = useChatStore();
  ...
  return (
    <header className="h-header px-2 bg-slate-100 dark:bg-slate-900 border-b border-slate-50 dark:border-slate-400">
